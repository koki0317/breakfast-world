...
ActiveRecord::Schema[7.0].define(version: 2022_08_13_115206) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["breakfast_id"], name: "index_favorites_on_breakfast_id"
  ...
  add_foreign_key "favorites", "breakfasts"
